...

{
  ...
  "confidenceNote": "ONE clean label near the confidence bar. NOT decorative. Under 12 words. Shape: 'Confidence: 82% this version underperforms' or 'Confidence: high — fix is reliable' or 'Confidence: strong based on seasonality, routing, and crowd timing'. Must carry actual meaning — never 'Confidence: high' alone.",
  "diagnosticSignals": [
  ...
  "consequence": {
    "bullets": [
      "EXACTLY 3 short consequence bullets describing what HAPPENS if the traveler books this as-is. Each under 16 words. Declarative, specific. Shape: 'You\\u2019d hit peak crowds during the hours that matter most.', 'Your movement days would compete with your best hours.', 'The trip would deliver the postcard version, not the one you actually want.' No icons, no warnings, no generic advice."
    ],
    "net": "ONE concluding sentence. Max 14 words. Declarative. Shape: 'You\\u2019d experience this destination at the wrong rhythm.'"
  },
  "coreFailure": [
    "EXACTLY 3–4 bullets naming what is STRUCTURALLY wrong with the plan. Each under 18 words. Focus on timing, routing, crowd dynamics, energy mismatch, or expectation gaps. Destination-specific. No generic advice. Declarative. Bullets should sound like findings, not suggestions. Shape examples: 'Single base in ${destShort}\\u2019s busiest corridor — the decision that compounds every other friction.', 'Timing puts you at the major sights during peak crowd surge (10:30am–1pm).', 'Energy mismatch — calm and intensity stacked into one base deliver neither.', 'No slack — a single delay collapses the rest of the trip.'"
  ],
  "predictiveInsights": [
    {
      "signal": "ONE highly specific predictive observation with a concrete number, window, or named threshold. 6–14 words. Must feel like insider knowledge, not advice. Reference a real local pattern: ferry cadence, crowd surge hour, price window, transit compression, booking-window tightening. Shape: 'Day-tripper surge peaks 11am–3pm', 'Ferry cadence collapses after 6:30pm in early June', 'Lodging price ceiling shifts +38% on your dates'.",
      "body": "ONE supporting line. 12–22 words. Declarative. Reference the traveler\\u2019s default routing or timing AND why it matters to the current trip setup. Shape: 'Your default routing lands between 11:15am and noon. Expect 3\\u00d7 the wait you\\u2019d have before 9:00am.'"
    }
  ],
  "howToFix": [
    {
      "title": "ONE imperative, executable move — framed as a CORRECTION, not a preference. Name concrete places, neighborhoods, months, hours, or constraints. 8–20 words. At least two of the items MUST carry a leverage clause — an em-dash tag naming why this move is non-optional. Shape examples: 'Split into two bases', 'Hit the major sight before 8:30am', 'Hold one day open to absorb weather or delays', 'Route evenings above the crowd line'. Never 'consider', 'try', 'think about'.",
  ...
  "beforeAfter": {
    ...
    "improves": [
      "EXACTLY 3 improvement chips. Each a terse fragment with a numeric or directional shift. Under 6 words. Shape: 'Crowd exposure \\u2212 45%', 'Morning light restored', 'Weather risk buffered', 'One open day protected'."
    ]
  },
  "personalizationCallback": "ONE short paragraph above the corrected-version itinerary. Use this exact shape: 'You want X. Your current plan delivers the [lunch-rush|postcard|default] version of the destination. This one does not.' Pull X from the traveler\\u2019s Desired vibes (${trip.vibes.join(", ") || "—"}) and Non-negotiables (${trip.mustHaves.join(", ") || "—"}), joined naturally. Under 32 words. No 'you said you wanted' framing. No 'opposite'.",
  "finalPlan": [
    {
  ...
  "whyThisWorks": "ONE short explanation reinforcing the logic of the corrected version. Name the behavioral principle (separating, sequencing, splitting, front-loading, calmer sequencing, separated energy, better use of light, crowd-window protection, recovery between movement and experience) AND why it delivers the trip the traveler came for. 20–40 words total. 1–2 sentences. Declarative. Shape: 'You\\u2019re separating calm and intensity, not forcing both into the same base. Calm compounds in the morning; energy lands after 5pm. The plan runs with the city, not against it.'"
}

Critical rules:
- Output ONLY the JSON object. No prose, no markdown fencing.
- Decisive voice throughout. Ban the words: consider, try, think about, you could, might, should probably, perhaps, it\\u2019s worth, may want to, very, really, quite, maximize, amazing, smart, personalized, AI-powered. Use "will" not "may". Imperatives not suggestions.
- Never use: travel optimization, best deals, smart recommendations, personalized intelligence, unlock amazing savings.
...
- "confidenceNote" must be a meaningful one-line label with actual content beyond the number. No bare 'Confidence: high'.
- "diagnosticSignals" MUST be EXACTLY 4 short mechanical fragments, 3–6 words each. No articles, no full sentences.
- "consequence.bullets" MUST be EXACTLY 3, each under 16 words. "consequence.net" is ONE sentence under 14 words.
- "coreFailure" MUST be 3–4 bullets describing what is STRUCTURALLY wrong (timing, routing, crowd dynamics, energy mismatch, expectation gaps). Destination-specific, each under 18 words. Bullets read as findings, not suggestions.
...
- "howToFix" MUST have 3 to 4 items. Each reads like a CORRECTION — at least two items carry an em-dash clause naming why the move is non-optional. Name concrete places, neighborhoods, hours. No filler travel tips.
...
- "personalizationCallback" uses 'You want X. Your current plan delivers the [lunch-rush|postcard|default] version of the destination. This one does not.' shape. Do NOT echo 'you said you wanted'. Do NOT say 'the opposite'.
...
- "whyThisWorks" names the BEHAVIORAL PRINCIPLE and why it delivers the user\\u2019s actual goal. 20–40 words, 1–2 sentences.
